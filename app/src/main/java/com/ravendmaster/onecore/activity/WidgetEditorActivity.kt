...
import com.ravendmaster.onecore.customview.MyColorPicker
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        widget_type_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                pub_topic_group.visibility = if (widgetType === WidgetData.WidgetTypes.HEADER || widgetType === WidgetData.WidgetTypes.GRAPH || widgetType === WidgetData.WidgetTypes.RGBLed || widgetType === WidgetData.WidgetTypes.SWITCH) View.GONE else View.VISIBLE
